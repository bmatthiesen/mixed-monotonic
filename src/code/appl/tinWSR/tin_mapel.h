...
#ifndef _TIN_MAPEL_H_
#define _TIN_MAPEL_H_
...
template <size_t Dim>
bool
inH(const typename pa::PA<Dim>::vtype& x, void*)
{
...
double
obj(const typename pa::PA<Dim>::vtype& x, void*)
{
...
template <size_t Dim, bool propFair = false>
struct Tin_Mapel : public pa::PA<Dim>
{
	Tin_Mapel(void *ud);
};

template <size_t Dim, bool propFair>
Tin_Mapel<Dim,propFair>::Tin_Mapel(void *ud)
 : pa::PA<Dim>()
{
